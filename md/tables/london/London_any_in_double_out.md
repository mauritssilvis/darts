...
However, they also apply to [master-in, double-out](London_master_in_double_out.md) and [double-in, double-out](London_double_in_double_out.md) games after the required double has been thrown.
