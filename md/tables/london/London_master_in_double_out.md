...
As long as a double or triple has been thrown, the extensive [any-in, double-out checkout tables](London_any_in_double_out.md) apply to these ranges of scores.
