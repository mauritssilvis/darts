...
As long as a double or triple has been thrown, the extensive [any-in, double-out checkout tables](Quadro_any_in_double_out.md) apply to these ranges of scores.

As for complete master-in, double-out checkouts, the following can be observed.
