...
As long as a double or triple has been thrown, the extensive [any-in, master-out checkout tables](Quadro_any_in_master_out.md) apply to these ranges of scores.
