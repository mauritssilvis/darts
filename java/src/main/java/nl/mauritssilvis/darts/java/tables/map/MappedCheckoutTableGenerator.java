...
public class MappedCheckoutTableGenerator implements CheckoutTableGenerator {
    private MappedCheckoutTableGenerator(BoardType boardType, CheckType checkInType, CheckType checkoutType) {
    }
     ...
     * dartboard, check-in and checkout types.
     */
    public static CheckoutTableGenerator of(BoardType boardType, CheckType checkInType, CheckType checkoutType) {
        return new MappedCheckoutTableGenerator(boardType, checkInType, checkoutType);
    }
